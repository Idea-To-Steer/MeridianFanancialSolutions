...
jQuery(document).ready(function(){
 if( jQuery('.custom_inner_content > .wpb_column > .vc_column-inner > .wpb_wrapper').length )  {
   jQuery( ".custom_inner_content > .wpb_column > .vc_column-inner > .wpb_wrapper" ).addClass('container');	
 }
});
</script>
